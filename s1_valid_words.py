...
custom_valid_words = {
    'smiley', 'healthcare', 'grandkids', 'hang', 'nonverbally', 'bible', 'email', 'handwritten', 'brings', 'tv', 'smartphone', 'app', 'okay', 'fond', 'audiobooks', "others"}
...
# add or 
# def add_or(sentence):
#     # Split the sentence by semicolons and newline characters
#     # parts = sentence.split(';')
#     # # Add "or" after semicolons
#     # parts_with_or = '; or'.join([part.strip() for part in parts])
#     # Split the resulting string by newline characters
#     parts_with_or_newline = sentence.split('\n')
#     # Add "or" after newlines
#     result = '\n or '.join(parts_with_or_newline)
#     return result



# for func, i in ICF_cate_comb.items():
#     for act, j in i.items():
#         # print(act)
#         if "sub_activity" in j:
#             new_sent = add_or(j["sub_activity"])
#             j["sub_activity"] = new_sent
#             print(j["sub_activity"])
